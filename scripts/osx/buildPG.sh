...
sign_and_upload(){
    ...
    # Sign app
        ...
        codesign --deep --force --verbose --sign "Developer ID Application: Arturo Castro" "dist/projectGenerator-$PLATFORM/projectGenerator.app/Contents/Frameworks/Electron Framework.framework"
